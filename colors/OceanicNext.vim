...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('PMenuSel',                   s:white,  s:blue,   '',          '')
  ...
  call s:hi('TSPunctDelimiter',           s:white,  '',       '',          '')
  call s:hi('TSParameter',                s:white,  '',       '',          '')
  ...
  call s:hi('TSConstructor',              s:white,  '','','')
  call s:hi('TSVariable',                 s:white,  '','','')
  call s:hi('TSOperator',                 s:white,  '','','')
